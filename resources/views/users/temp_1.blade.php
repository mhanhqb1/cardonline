        ...
        <div class="p-4 md:p-12 text-center">
            ...
            @if (!empty($userSocials))
                @foreach($userSocials as $v)
                    <a class="link" href="{{ $v->url }}" data-tippy-content="{{ $v->type }}"><span class="sicon sicon-{{ $v->type }}-4"></span></a>
                @endforeach
            @endif
            </div>
